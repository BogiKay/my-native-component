...
import com.facebook.react.viewmanagers.CustomSwitchComponentManagerDelegate
import com.facebook.react.viewmanagers.CustomSwitchComponentManagerInterface

@ReactModule(name = "CustomSwitchComponent")
class CustomSwitchViewManager : SimpleViewManager<CustomSwitchView>(), CustomSwitchComponentManagerInterface<CustomSwitchView> {
    private var mDelegate = CustomSwitchComponentManagerDelegate(this)
    ...
    override fun getDelegate(): ViewManagerDelegate<CustomSwitchView>? {
        return mDelegate
    }
